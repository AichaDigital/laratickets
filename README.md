...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laratickets.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laratickets)
...
```bash
php artisan vendor:publish --tag="laratickets-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laratickets-config"
```
...
```bash
php artisan vendor:publish --tag="laratickets-views"
```

## Usage

```php
$laratickets = new Aicha Digital\Laratickets();
echo $laratickets->echoPhrase('Hello, Aicha Digital!');
```
